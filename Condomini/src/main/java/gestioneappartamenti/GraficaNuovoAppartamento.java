 ...
 * @author User
 */
public class GraficaNuovoAppartamento extends FinestraGrafica {    
        Ascoltatore listener = new Ascoltatore();
        JLabel j1,j2,j3;
        JTextField jt1,jt2,jt3;
        JButton jb1,jb2,jb3,jb4,jb5;
        public GraficaNuovoAppartamento(String titolo,int appartamento){
        super(titolo);
    ...
    public class Ascoltatore implements ActionListener{
        ...
        if(src == jb4){
            ...
            h = true;
            a = jt1.getText();
            if(a.trim().length() == 0 || "nessuno".equals(a.trim().toLowerCase())){
                h = false;
            }
            }
            ...
            g = true;
            b = jt2.getText();
            if(b.trim().length() == 0 || "nessuno".equals(b.trim().toLowerCase())){
                g = false;
            }
            }
            catch(NullPointerException y){
            ...
            if(h == true && g == true && l == true){
            e = jb5.getText();  
            f = Integer.parseInt(e);
            JOptionPane.showMessageDialog(null,"L'appartamento"+" "+f+" "+"e' stato occupato da"+" "+a+" "+t); 
